                    ...
                    <div>
                        ...
                        <div className="relative group">
                            ...
                            <input 
                                ...
                                className="w-full bg-slate-50 border border-transparent hover:border-slate-200 focus:bg-white focus:border-finance-primary/40 focus:ring-4 focus:ring-finance-primary/10 rounded-xl py-3 text-slate-900 font-bold transition-all outline-none"
