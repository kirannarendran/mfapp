            ...
            <div className="search-container mb-6">
                ...
                <div className="relative mb-3">
                    ...
                    <input
                        ...
                        className="w-full text-base pl-12 pr-10 py-3.5 shadow-sm border border-slate-200 rounded-2xl bg-white focus:outline-none focus:ring-2 focus:ring-finance-primary/20 focus:border-finance-primary transition-all text-slate-900 placeholder:text-slate-400"
                    />
                    {searchTerm && (
                        <button
